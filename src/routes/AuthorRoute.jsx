...
export default function AuthorRoute({ children }) {
  const { user, isAuthor, loading, profile } = useAuth();

  console.log('[AUTHOR ROUTE] loading:', loading);
  console.log('[AUTHOR ROUTE] user:', user?.email);
  console.log('[AUTHOR ROUTE] profile:', profile);
  console.log('[AUTHOR ROUTE] isAuthor:', isAuthor);
