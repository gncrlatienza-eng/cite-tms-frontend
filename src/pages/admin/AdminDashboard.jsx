  ...
  return (
    <div className="ad-detail-wrap">
      ...
      <div className="ad-detail-card">
        ...
        {req.status === "pending" && (
          <div style={{ display: "flex", gap: 10, marginTop: 20, padding: "0 28px 24px" }}>
    ...
    <div className="ad-detail-wrap">
      ...
      <div className="ad-detail-card">
        ...
        <div className="ad-cert-section" style={{ marginTop: 20 }}>
          ...
          {paper.abstract && (<div style={{ marginTop: 16, padding: "0 0 8px" }}><div className="ad-detail-label" style={{ marginBottom: 6 }}>Abstract</div><p style={{ fontSize: 13, color: "#374151", lineHeight: 1.7 }}>{paper.abstract}</p></div>)}
        </div>
        <div className="ad-cert-section" style={{ marginTop: 20 }}>
        ...
        {req.status === "pending" && (
          <div style={{ display: "flex", gap: 10, margin: "24px 28px 24px", paddingTop: 20, borderTop: "1px solid #f1f3f4" }}>
...
export default function AdminDashboard() {
  ...
  const NAV_ITEMS = [
    { id: "papers",          label: "Papers",                icon: <BookIcon />,     badge: papers.length },
    { id: "requests",        label: "Access Requests",       icon: <LockIcon />,     badge: pendingRequestCount },
    { id: "upgrades",        label: "Author Upgrades",       icon: <UserPlusIcon />, badge: pendingUpgradeCount },
    { id: "upload-requests", label: "Upload Paper Requests", icon: <UploadIcon />,   badge: pendingUploadPaperCount },
    { id: "whitelist",       label: "Whitelist",             icon: <ListIcon />,     badge: whitelist.length },
  ];
    ...
    <>
      <style>{`
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .ad-sidebar-brand:hover { opacity: 0.85; }
        ...
        .ad-brand-text { display: flex; flex-direction: column; }
        .ad-brand-name { font-size: 14px; font-weight: 700; color: #111827; letter-spacing: -0.2px; }
        .ad-brand-sub  { font-size: 10px; font-weight: 500; color: #9aa0a6; letter-spacing: 0.04em; margin-top: 1px; }
        ...
        .ad-nav-item:hover { background: #f1f3f4; color: #202124; }
        .ad-nav-item.active { background: #f0fdf4; color: #166534; font-weight: 600; }
        .ad-nav-item.active svg { color: #16a34a; }

        .ad-nav-icon { width: 16px; height: 16px; flex-shrink: 0; opacity: 0.7; }
        ...
        .ad-user-section:hover { background: #f1f3f4; }
        ...
        .ad-user-name { font-size: 13px; font-weight: 600; color: #202124; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; }
        .ad-user-role { font-size: 10.5px; color: #9aa0a6; }
        ...
        .ad-user-dropdown {
          ...
          overflow: hidden;
          animation: adDropUp 0.16s cubic-bezier(0.34,1.56,0.64,1);
        }
        @keyframes adDropUp {
        ...
        .ad-dropdown-header { padding: 12px 14px; border-bottom: 1px solid #f3f4f6; }
        .ad-dropdown-name  { font-size: 13px; font-weight: 600; color: #111827; }
        .ad-dropdown-email { font-size: 11px; color: #9ca3af; margin-top: 2px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; }
        .ad-dropdown-role  { display: inline-block; margin-top: 5px; font-size: 9.5px; font-weight: 700; letter-spacing: 0.8px; text-transform: uppercase; padding: 2px 8px; border-radius: 20px; background: #f0fdf4; color: #166534; }
        ...
        .ad-topbar-title { font-size: 16px; font-weight: 700; color: #111827; }
        .ad-topbar-sub   { font-size: 12px; color: #9aa0a6; margin-top: 1px; }
        ...
        .ad-section-title { font-size: 20px; font-weight: 700; color: #202124; }
        ...
        .ad-table th { padding: 11px 16px; text-align: left; font-size: 10.5px; font-weight: 700; text-transform: uppercase; letter-spacing: 0.07em; color: #80868b; }
        ...
        .ad-approve-btn { background: #f0fdf4; border: 1.5px solid #bbf7d0; color: #166534; font-size: 12px; font-weight: 600; font-family: inherit; padding: 6px 14px; border-radius: 7px; cursor: pointer; transition: background 0.15s; display: inline-flex; align-items: center; gap: 6px; }
        .ad-approve-btn:hover { background: #dcfce7; }
        .ad-approve-btn:disabled { opacity: .5; cursor: not-allowed; }
        .ad-reject-btn { background: #fef2f2; border: 1.5px solid #fecaca; color: #9b0000; font-size: 12px; font-weight: 600; font-family: inherit; padding: 6px 14px; border-radius: 7px; cursor: pointer; transition: background 0.15s; }
        ...
        .ad-detail-label { font-size: 10.5px; font-weight: 700; text-transform: uppercase; letter-spacing: 0.07em; color: #9aa0a6; margin-bottom: 5px; }
        ...
        /* ── Modal ── */
        .ad-overlay { position: fixed; inset: 0; background: rgba(0,0,0,0.45); backdrop-filter: blur(2px); z-index: 1000; display: flex; align-items: center; justify-content: center; padding: 20px; animation: adFadeIn 0.18s ease; }
      ...
      <div className="ad-root">
        ...
        <aside className="ad-sidebar">
          <div className="ad-sidebar-brand" onClick={() => navigate("/")}>
            ...
            <div className="ad-brand-text">
              <span className="ad-brand-name">CITE-TMS</span>
          ...
          <div className="ad-sidebar-footer">
            <div className="ad-user-section" ref={dropdownRef} onClick={() => setDropdownOpen((o) => !o)}>
              {avatar
              ...
              <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="#9aa0a6" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
                <polyline points="18 15 12 9 6 15"/>
              </svg>

              {dropdownOpen && (
                <div className="ad-user-dropdown" onClick={(e) => e.stopPropagation()}>
